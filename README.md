...
###3	MINI-MUNDO<br>
Foi solicitado um sistema para uma academia que ainda trabalha com blocos de papel e arquivos guardados em pastas e armários de metal, a academia também não tem um bom controle de pagamento, seja para professores que não sabem ao certo quando pagamento, quanto para alunos, pois não tem nada que possa avisar quando é o pagamento de determinado aluno, tendo sempre que ir olhar nas fichas e na maioria das vezes gerando atrasos. A academia ainda conta com um sistema de ficar imprimindo as séries de exercício em folhas de papel, o que gera um gasto desnecessário de folhas, pois com frequência o aluno acaba perdendo a folha e tendo sempre que imprimir novamente.
